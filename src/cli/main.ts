import { DefinitionList } from '../language/generated/ast.js';
...
export const generateAction = async (fileName: string, opts: GenerateOptions): Promise<void> => {
    ...
    const model = await extractAstNode<DefinitionList>(fileName, services);
...
export default function(): void {
    ...
    const fileExtensions = LivExLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
